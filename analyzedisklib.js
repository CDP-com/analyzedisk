...
function downloadApp()
{
    if ( installApp() )
    {
        location.href = "analyzediskinstaller.exe";
    }
...
{
    document.location.href = "http://factory.snapback-apps.com/commune/2011/11/03/analyze-disk-user-developer-page/"
}

function goOTMApp()
{
    // document.location.href = "http://www.engineering.cdp.com/a/otmapp";
    document.location.href = "http://www.factory.snapback-apps.com/otmapp";
}
...
{
    window.open( "http://factory.snapback-apps.com/commune/2011/11/03/analyze-disk-user-developer-page/", "", "height=400,width=700,location=yes,menubar=yes,toolbar=yes,scrollbars=yes,resizable=yes" );
    // document.location.href = "http://factory.snapback-apps.com/wordpress/wp-content/plugins/autologin-guest/autologin.php?redirect_to=http://factory.snapback-apps.com/wordpress/analyzedisk/wp-admin/post.php%3Fpost=12%26action=edit";
}
...
function checkdisk()
{
    ...
    if ( isLocal )
    {
		...
		//Refresh iframe with results
		var htmlObj = document.getElementById("resultsframe");
		htmlObj.src = "disklog.html";
		cursor_clear();
    }
}
