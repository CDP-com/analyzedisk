//
// analyzedisk.js
// Summary: template-analyzedisk.js used to generate analyzedisk.js. 
// Icon: analyzedisk.jpg
//

var ManVer = "1438267072190";
function GetManVer(){ return ManVer; }

var strFileURL = "http://snapback-apps.com/analyzedisk/analyzedisk1438267072190.cdpupdate";
function GetstrFileURL(){ return strFileURL; }

var strOnlineURL = "http://snapback-apps.com/analyzedisk/invis.gif";
function GetstrOnlineURL(){ return strOnlineURL; }

var SyncCookieName = "analyzediskpckgid";
function GetSyncCookieName(){ return SyncCookieName; }

// the following variables are defined outside the scope of this template:
// http://snapback-apps.com/analyzedisk/analyzedisk.xml
// %ALLUSERSPROFILE%\\cdp\\snapback\\apps\\analyzedisk\\analyzedisk.xml
// http://snapback-apps.com/analyzedisk/index.html
// index.html
// http://snapback-apps.com/analyzedisk/ax/CDPUpdater.cab
// soon:-1,-1,-1,-1

var ManifestFile = "analyzedisk.xml"
function GetManifestFile() { return ManifestFile; }

var ManifestURL_Remote = "http://snapback-apps.com/analyzedisk/analyzedisk.xml";
function GetManifestURL_Remote(){ return ManifestURL_Remote; }

var ManifestURL_Local = "%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\analyzedisk\\analyzedisk.xml";
function GetManifestURL_Local(){ return ManifestURL_Local; }

var StartUrl_Remote = "http://snapback-apps.com/analyzedisk/index.html";
function GetStartUrl_Remote() { return StartUrl_Remote; }

var StartUrl_Local = "index.html";
function GetStartUrl_Local() { return StartUrl_Local; }
...
function switchToLocal()
{
    ...
    {
        output = doCommand2( "takemelocal" + "," + "\"" + escape("%ALLUSERSPROFILE%\\cdp\\analyzedisk\\startmom.vbs") + "\"" );
    }
